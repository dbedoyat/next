	...
	const Index = ({ posts = [] }) => (
			...
			<Parallax pages={9} >
				<section id="work" className="text-center">
					...
					<ParallaxLayer className="background" offset={0} speed={0.2} factor={9} style={{ backgroundImage: url('stars', true), backgroundSize: 'cover', filter: 'brightness(0)', left: '0', backgroundRepeat: 'repeat', backgroundPosition: 'center top'}} />
					<ParallaxLayer className="background" offset={0} speed={0.1} factor={9} style={{ backgroundImage: url('starsinverse', true), backgroundSize: 'cover', filter: 'brightness(0.6)', left: '0' , backgroundRepeat: 'repeat', backgroundPosition: 'center top'}} />
